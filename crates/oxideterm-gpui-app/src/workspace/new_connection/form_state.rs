...
mod tests {
    ...
    use super::{
        ...
        StandaloneSftpTransferMode, auth_family_from_tab, auth_tab_from_key_source,
        backspace_current_connection_field, connection_secret_field_visible,
        default_auth_tab_for_family, form_from_mosh_profile, form_from_remote_desktop_profile,
        form_from_serial_profile, form_from_telnet_profile, identity_agent_from_form,
        identity_agent_selector, insert_text_into_current_connection_field, key_source_from_tab,
